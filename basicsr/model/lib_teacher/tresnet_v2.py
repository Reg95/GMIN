...
from timm.models.layers import  BlurPool2d, InplaceAbn, ClassifierHead, SEModule

# from model import MODEL
from basicsr.model import MODEL
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        return out
# 将此添加到如basicsr/model/lib_teacher/space_to_depth.py的文件中
import torch.nn as nn
...
class SpaceToDepthModule(nn.Module):
    ...
    def forward(self, x):
        ...
        transposed_x = unfolded_x.permute(0, 3, 5, 1, 2, 4)
        return transposed_x.contiguous().view(n, c * (self.block_size ** 2), h // self.block_size, w // self.block_size)
