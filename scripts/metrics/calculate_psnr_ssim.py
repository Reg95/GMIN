...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default=r'N:\results\Cacl\Set14_img001\HR1', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default=r'N:\results\Cacl\Set14_img001\SR1', help='Path to restored images')
